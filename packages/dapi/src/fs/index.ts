...
export const readFile = async (file: string, warn = false) => {
  ...
  try {
    ...
    if (warn) {
      throw new CustomError(`Cannot read file: ${file}`, { cause: e })
    }
  }
  return contents;
};
 ...
 * @returns an object {dirs,files} containing list of directories & files, null in case of error
 */
export const readDir = async (dir: string, warn = false, hiddenItems = false) => {
  ...
  try {
    ...
    if (warn) {
      throw new CustomError(`Cannot read dir: ${dir}`, { cause: e })
    }
    return null;
  }
...
export const writeFile = async (file: string, contents: string) => {
  ...
  try {
    ...
    throw new CustomError(`Error while writing to ${file}`, { cause: e });
  }
  return true;
};
...
export const appendToFile = async (file: string, contents: string) => {
  ...
  try {
    ...
    throw new CustomError(`Error while appending to ${file}`, { cause: e });
  }
  return true;
};
...
export const renameFile = async (oldpath: string, newpath: string) => {
  ...
  try {
    ...
    throw new CustomError(`Error while renaming file ${oldpath} to ${newpath}`, { cause: e });
  }
  return true;
};
...
export const createDir = async (dir: string) => {
  ...
  try {
    ...
    throw new CustomError(`Error while creating directory: ${dir}`, { cause: e });
  }
  return true;
};
...
export const deleteFile = async (file: string) => {
  ...
  try {
    ...
    throw new CustomError(`Error while deleting file ${file}`, { cause: e });
  }
  return true;
};
...
export const deleteDir = async (dir: string) => {
  ...
  try {
    ...
    throw new CustomError(`Error while deleting dir ${dir}`, { cause: e });
  }
  return true;
};
